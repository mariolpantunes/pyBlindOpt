...
class TestGA(unittest.TestCase):
    def test_ga_00(self):
        ...
        solution, objective = ga.genetic_algorithm(utils.f1, bounds, n_iter=100, verbose=False)
        self.assertAlmostEqual(solution[0], 0, 1)
    
    def test_ga_01(self):
        bounds = np.asarray([(-5.0, 5.0), (-5.0, 5.0)])
        result, objective = ga.genetic_algorithm(utils.f2, bounds, n_iter=100, verbose=False)
    ...
    def test_ga_02(self):
        c = utils.CountEpochs()
        bounds = np.asarray([(-5.0, 5.0), (-5.0, 5.0)])
        result, objective = ga.genetic_algorithm(utils.f2, bounds, n_iter=10, callback=c.callback, verbose=False)
        desired = 10
    ...
    def test_ga_03(self):
        ...
        result, _ = ga.genetic_algorithm(utils.f2, bounds, population=population, n_iter=100, verbose=False)
        desired = np.array([0.0, 0.0])
    ...
    def test_ga_05(self):
        ...
        bounds = np.asarray([(-5.0, 5.0), (-5.0, 5.0)])
        population = [np.array([1,1]), np.array([-1,1]), np.array([2,-2]), np.array([.5,-.5]), np.array([-.5,.5])]
        _, _, debug = ga.genetic_algorithm(utils.f2, bounds, population=population, n_iter=n_iter, verbose=False, debug=True)
    ...
    def test_de_06(self):
        ...
        result, objective = ga.genetic_algorithm(utils.sphere, bounds, n_iter=n_iter, callback=c.callback, verbose=False)

...
class TestLR(unittest.TestCase):
    def test_lr_00(self):
        x = np.array([[ 0.64768854],[ 0.49671415],[-0.23413696],[-1.72491783],
        [-0.90802408],[-1.4123037 ],[-0.46341769],[-1.01283112],[-0.23415337],
        [ 0.24196227],[-0.46947439],[ 1.57921282],[ 0.76743473],[-0.56228753],
        [ 1.52302986],[-1.91328024],[ 0.54256004],[-0.1382643 ],[-0.46572975],
        [ 0.31424733]])

        y = np.array([ 47.45554635,  18.24731687, -14.28633346, -80.27447804,
        -21.96406129, -56.05545461, -28.28595535, -55.0480211 ,
        -9.82349843,   7.29963131, -19.37407957,  67.82137943,
        41.63247323, -22.91880407,  72.22045141, -87.29766413,
        20.29561687,  -2.1217765 , -22.37282384,  21.97582345])
